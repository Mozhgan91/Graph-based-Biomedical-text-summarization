...
public class Summarizer {
	   ...
	   //for memory usage of the programme
       ...
       public static void main(String[] args){
    	   try{
    		   ...
    		   int doc_num; //the number of the current document
    		   int compresion_rate=30;//for summary
    		   int cluster_number;//the number of the clusters
    		   long StartTime;//for computing time
    		   long endTime;// for computing time
    		   long temp = 0;// for computing time
    		   long memory = 0; //for memory usage
    		   
    		   
    		   for(cluster_number = 3; cluster_number <=3; cluster_number++)
    		   {
    			   for(minsup = 0.12; minsup <= 0.12; minsup++)
    			   {
    				   
    				   for(doc_num=1; doc_num<=1; doc_num++)
    	    		   {
    	    			   //System.out.println("\n************************* Document: " + doc_num + " *************************");
    						...
    						*/
    						...
    						for(int i=0; i<FrequentItemsDoc.size(); i++)
    							{
    							     System.out.println(FrequentItemsDoc.get(i).Itemsets.size());
    				    	...
    				    	*/
    					       ...
    					       //writing the summary into a file
    					         ...
    					         String final_summary ="<html>\n"
    					            ...
    					            System.out.println(" Total time ~ " + temp + " ms");
